...
Variable ExecutionEngine::LoadConstant(JavaClass *pClass, u1 nIndex)
{
	...
	case CONSTANT_String:
		...
		pStrVal = append(pStrVal, strTemp);
...
u2 ExecutionEngine::GetMethodParametersCount(char * strMethodDesc)
{
	u2 count=0;
...
u2 ExecutionEngine::GetMethodParametersStackCount(char * strMethodDesc)
{
	u2 count=0;
...
pNativeMethod GetNativeMethod(char * strSign)
{
	#ifdef JOSBUILD
	if(false)
	{
	}
	else if(!strcmp(strSign, "String@valueOf(F)LString;"))
	{
		return String_valueOf_F;
	}
	else if(!strcmp(strSign, "String@valueOf(J)LString;"))
	{
		return String_valueOf_J;
	}
	else if(!strcmp(strSign, "StringBuilder@append(LString;)LStringBuilder;"))
	{
		return StringBuilder_append_String;
	}
	else if(!strcmp(strSign, "StringBuilder@append(I)LStringBuilder;"))
	{
		return StringBuilder_append_I;
	}
	else if(!strcmp(strSign, "StringBuilder@append(C)LStringBuilder;"))
	{
		return StringBuilder_append_C;
	}
	else if(!strcmp(strSign, "StringBuilder@append(Z)LStringBuilder;"))
	{
		return StringBuilder_append_Z;
	}
	else if(!strcmp(strSign, "StringBuilder@append(LObject;)LStringBuilder;"))
	{
		return StringBuilder_append_Object;
	}
	else if(!strcmp(strSign, "StringBuilder@append(F)LStringBuilder;"))
	{
		return StringBuilder_append_F;
	}
	else if(!strcmp(strSign, "StringBuilder@append(J)LStringBuilder;"))
	{
	...
	else if(!strcmp(strSign, "StringBuilder@toString()LString;"))
	{
		return StringBuilder_toString_String;
	}
	else if(!strcmp(strSign, "Test@Print(LString;)V"))
	{
		return Print;
	}
	...
	else if(!strcmp(strSign, "java/lang/String@valueOf(F)Ljava/lang/String;"))
	{
		return String_valueOf_F;
	}
	else if(!strcmp(strSign, "java/lang/String@valueOf(J)Ljava/lang/String;"))
	{
		return String_valueOf_J;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(Ljava/lang/String;)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_String;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(I)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_I;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(C)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_C;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(Z)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_Z;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(Ljava/lang/Object;)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_Object;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(F)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_F;
	}
	else if(!strcmp(strSign, "java/lang/StringBuilder@append(J)Ljava/lang/StringBuilder;"))
	{
		return StringBuilder_append_J;
	}
	...
	else if(!strcmp(strSign, "java/lang/StringBuilder@toString()Ljava/lang/String;"))
	{
		return StringBuilder_toString_String;
	}
	else if(!strcmp(strSign, "Test@Print(Ljava/lang/String;)V"))
	{
		return Print;
	}
	#endif
...
u4 ExecutionEngine::ExecuteNativeMethod(Frame* pFrameStack)
{
	...
	//!!!!!!!!!!!!!!!!
	strSignature = append(append(strClassName, "@"), append(strMethod, strDesc));
...
{
	Variable *pVar= (Variable *)malloc(sizeof(Variable)*(count+1));
